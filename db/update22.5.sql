...
ALTER TABLE `zt_ai_agent` ADD `cycleConfig` text NULL COMMENT '周期配置' AFTER `cycleType`;
ALTER TABLE `zt_ai_agent` ADD `notifyRule` text NULL COMMENT '通知规则JSON：roles/users/methods' AFTER `cycleConfig`;

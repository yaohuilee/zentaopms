...
CREATE TABLE IF NOT EXISTS `zt_bug` (
  ...
  `lines` varchar(50) NOT NULL DEFAULT '',
...
(21, 'artifact', 'browse'),
(21, 'artifact', 'create'),
(21, 'artifact', 'createDir'),
(21, 'artifact', 'delete'),
(21, 'artifact', 'deleteDir'),
(21, 'artifact', 'deleteArtifact'),
(21, 'artifact', 'edit'),
(21, 'artifact', 'editDir'),
(21, 'artifact', 'editArtifact'),
(21, 'artifact', 'uploadArtifact'),
(21, 'codescan', 'activeIssue'),
(21, 'codescan', 'batchunlinkrule'),
(21, 'codescan', 'browse'),
(21, 'codescan', 'changerulesetstate'),
(21, 'codescan', 'changesolutionstate'),
(21, 'codescan', 'changeState'),
(21, 'codescan', 'confirmIssue'),
(21, 'codescan', 'createPlan'),
(21, 'codescan', 'createruleset'),
(21, 'codescan', 'createsolution'),
(21, 'codescan', 'createTrigger'),
(21, 'codescan', 'deletePlan'),
(21, 'codescan', 'deleteruleset'),
(21, 'codescan', 'deletesolution'),
(21, 'codescan', 'deleteTrigger'),
(21, 'codescan', 'editPlan'),
(21, 'codescan', 'editruleset'),
(21, 'codescan', 'editsolution'),
(21, 'codescan', 'editTrigger'),
(21, 'codescan', 'exec'),
(21, 'codescan', 'ignoreIssue'),
(21, 'codescan', 'issue'),
(21, 'codescan', 'issueView'),
(21, 'codescan', 'linkrule'),
(21, 'codescan', 'linkset'),
(21, 'codescan', 'overview'),
(21, 'codescan', 'plan'),
(21, 'codescan', 'planView'),
(21, 'codescan', 'resend'),
(21, 'codescan', 'ruleset'),
(21, 'codescan', 'rulesetview'),
(21, 'codescan', 'solution'),
(21, 'codescan', 'solutionview'),
(21, 'codescan', 'task'),
(21, 'codescan', 'taskLog'),
(21, 'codescan', 'taskView'),
(21, 'codescan', 'unlinkrule'),
(21, 'codescan', 'unlinkset'),
(21, 'codescan', 'unlinkSolution'),
(21, 'codescan', 'view'),
(21, 'pipeline', 'edit'),
(21, 'pipeline', 'browse'),
(21, 'pipeline', 'create'),
...
(21, 'repo', 'blame'),
(21, 'repo', 'browse'),
(21, 'repo', 'browseBranch'),
(21, 'repo', 'browseSystem'),
(21, 'repo', 'browseTag'),
(21, 'repo', 'browseWebhooks'),
(21, 'repo', 'create'),
(21, 'repo', 'createBranch'),
(21, 'repo', 'createRepo'),
(21, 'repo', 'createTag'),
(21, 'repo', 'createWebhook'),
(21, 'repo', 'delete'),
(21, 'repo', 'deleteBranch'),
(21, 'repo', 'deleteComment'),
(21, 'repo', 'deleteTag'),
(21, 'repo', 'deleteWebhook'),
(21, 'repo', 'diff'),
(21, 'repo', 'download'),
(21, 'repo', 'downloadCode'),
(21, 'repo', 'edit'),
(21, 'repo', 'editComment'),
(21, 'repo', 'editWebhook'),
(21, 'repo', 'enableWebhook'),
(21, 'repo', 'import'),
(21, 'repo', 'linkBug'),
(21, 'repo', 'linkStory'),
(21, 'repo', 'linkTask'),
...
(21, 'repo', 'unlink'),
(21, 'repo', 'view'),
(21, 'repobranchrule', 'setBranchRule'),
(21, 'repobranchtype', 'browse'),
(21, 'repobranchtype', 'create'),
(21, 'repobranchtype', 'delete'),
(21, 'repobranchtype', 'edit'),
(21, 'repobranchtype', 'import'),
(21, 'reporeviewflow', 'browse'),
(21, 'reporeviewflow', 'changeStatus'),
...
(21, 'space', 'view'),
(21, 'space', 'group'),
(21, 'space', 'createGroup'),
(21, 'space', 'deleteGroup'),
(21, 'space', 'editGroup'),
(21, 'space', 'importGroup'),
(21, 'space', 'members'),
(21, 'space', 'manageMembers'),
(21, 'space', 'managePriv'),
...
(22, 'codescan', 'overview'),
(22, 'codescan', 'plan'),
(22, 'codescan', 'planView'),
(22, 'codescan', 'ruleset'),
(22, 'codescan', 'rulesetview'),
(22, 'codescan', 'solution'),
(22, 'codescan', 'solutionview'),
(22, 'codescan', 'task'),
(22, 'codescan', 'taskLog'),
(22, 'codescan', 'taskView'),
(22, 'codescan', 'view'),
(22, 'pipeline', 'browse'),
(22, 'pipeline', 'execution'),
(22, 'pipeline', 'execView'),
(22, 'ppm', 'browse'),
(22, 'ppm', 'view'),
(22, 'repo', 'addComment'),
(22, 'repo', 'blame'),
(22, 'repo', 'browse'),
(22, 'repo', 'browseBranch'),
(22, 'repo', 'browseSystem'),
(22, 'repo', 'browseTag'),
(22, 'repo', 'browseWebhooks'),
(22, 'repo', 'diff'),
(22, 'repo', 'download'),
(22, 'repo', 'downloadCode'),
(22, 'repo', 'log'),
(22, 'repo', 'logWebhook'),
(22, 'repo', 'maintain'),
(22, 'repo', 'review'),
...
(23, 'artifact', 'deleteArtifact'),
(23, 'artifact', 'editDir'),
(23, 'artifact', 'editArtifact'),
(23, 'artifact', 'uploadArtifact'),
(23, 'codescan', 'createPlan'),
(23, 'codescan', 'createTrigger'),
(23, 'codescan', 'editPlan'),
(23, 'codescan', 'editTrigger'),
(23, 'codescan', 'deletePlan'),
(23, 'codescan', 'deleteTrigger'),
(23, 'codescan', 'activeIssue'),
(23, 'codescan', 'ignoreIssue'),
(23, 'codescan', 'confirmIssue'),
(23, 'codescan', 'exec'),
(23, 'codescan', 'resend'),
(23, 'codescan', 'browse'),
(23, 'codescan', 'issue'),
(23, 'codescan', 'issueView'),
(23, 'codescan', 'overview'),
(23, 'codescan', 'plan'),
(23, 'codescan', 'planView'),
(23, 'codescan', 'ruleset'),
(23, 'codescan', 'rulesetview'),
(23, 'codescan', 'solution'),
(23, 'codescan', 'solutionview'),
(23, 'codescan', 'task'),
(23, 'codescan', 'taskLog'),
(23, 'codescan', 'taskView'),
(23, 'codescan', 'view'),
(23, 'pipeline', 'edit'),
(23, 'pipeline', 'browse'),
(23, 'pipeline', 'create'),
...
(23, 'repo', 'blame'),
(23, 'repo', 'browse'),
(23, 'repo', 'browseBranch'),
(23, 'repo', 'browseSystem'),
(23, 'repo', 'browseTag'),
(23, 'repo', 'browseWebhooks'),
(23, 'repo', 'createBranch'),
(23, 'repo', 'createTag'),
(23, 'repo', 'deleteBranch'),
(23, 'repo', 'deleteTag'),
(23, 'repo', 'diff'),
(23, 'repo', 'download'),
(23, 'repo', 'downloadCode'),
(23, 'repo', 'linkBug'),
(23, 'repo', 'linkStory'),
(23, 'repo', 'linkTask'),
(23, 'repo', 'log'),
...
('lang',        '问题解决方式',     'issueResolution',           '1', 'rnd', 'admin', '1970-01-01 00:00:01', 'issueResolution',           '', '', ''),
...
(3, 'zt_task_polishing', '任务润色', '优化任务中标题、描述等字段的表述，使任务表述更清晰准确。', 0, 'task', 'detail', 'task.edit', ',task.name,task.desc,task.pri,task.status,task.estimate,task.consumed,task.left,task.progress,task.estStarted,task.realStarted,', 'task.edit', '优化其中各字段的表述，使表述清晰准确，明确任务目标。', '必要时指出任务的风险点。', '你是一名经验丰富的开发工程师。', '精通多种编程语言和框架、熟悉前后端技术和架构、擅长性能优化和安全防护、熟悉云计算和容器化技术、能够协调多人协作和项目管理。', 'system', '2023-08-10 13:24:14', 'active'),
(4, 'zt_story_to_task', '需求转任务', '根据需求的标题、描述和验收标准等，将需求转化为对应的可实施的开发任务。', 0, 'story', 'detail', 'story.totask', ',story.title,story.spec,story.verify,story.product,story.module,story.pri,story.category,story.estimate,', 'story.totask', '将需求转化为对应的开发任务要求。', '', '请你扮演一名资深的产品经理。', '负责产品战略、设计、开发、数据分析、用户体验、团队管理、沟通协调等方面，需要具备多种技能和能力，以实现产品目标和公司战略。同时精通多种编程语言和框架、熟悉前后端技术。', 'system', '2023-08-10 13:24:14', 'active'),
(5, 'zt_bug_polishing', 'Bug润色', '优化需求中标题、描述和验收标准等字段，使表述清晰准确。', 0, 'bug', 'detail', 'bug.edit', ',bug.title,bug.steps,bug.severity,bug.pri,bug.status,bug.confirmed,bug.type,', 'bug.edit', '优化其中各字段的表述，使表述清晰准确。', 'Bug描述格式建议使用：[步骤]<一步一步复现Bug的步骤>[结果]<Bug导致的结果描述>[期望]<Bug修复后期望的描述>', '作为一名资深的测试工程师。', '熟悉测试流程和方法，精通自动化测试和性能测试，能够设计和编写测试用例和测试脚本，擅长问题诊断和分析，熟悉敏捷开发和持续集成，能够协调多部门合作和项目管理。开发工程师应该是专业且严谨的。', 'system', '2023-08-10 13:24:14', 'active'),
(6, 'zt_doc_polishing', '文档润色', '优化任务中标题、描述等字段的表述，使任务表述更清晰准确。', 0, 'doc', 'detail', 'doc.edit', ',doc.content,doc.title,', 'doc.edit', '我希望你能帮我润色标题和文档正文。', '要求语句要通顺，逻辑要清晰，没有错别字且更具结构化。', '你是一名文章写得很好的文案编辑。', '文笔流畅、条理清晰。精通广告文案写作和编辑，擅长创意思维和品牌策略，能够进行市场调研和竞品分析，具有敏锐的审美和语言表达能力，能够协调多部门合作和项目管理，具有良好的沟通和协调能力。', 'system', '2023-08-31 15:54:57', 'active'),
(7, 'zt_bug_to_story', 'Bug转需求', '根据Bug数据转化为相应的研发需求。', 0, 'bug', 'detail', 'story.create', ',bug.title,bug.steps,bug.severity,bug.pri,bug.status,bug.confirmed,bug.type,', 'story.create', '请将Bug转化为相应的研发需求。', '分条编写需求描述，分条编写验收标准，需求逻辑条理清晰。', '请你扮演一名资深的产品经理。', '负责产品战略、设计、开发、数据分析、用户体验、团队管理、沟通协调等方面，需要具备多种技能和能力，以实现产品目标和公司战略。', 'system', '2023-11-17 12:00:00', 'active'),
(8, 'zt_split_productplan', '拆分一个子计划', '优化需求中标题、描述和验收标准等字段，使表述清晰准确。', 0, 'productplan', 'detail', 'productplan.create', ',productplan.title,productplan.desc,productplan.begin,productplan.end,', 'productplan.create', '根据给定计划名称、描述、计划开始时间和计划结束时间，将给定计划明确为其小范围的子计划。拆分出来的子计划可以更专注于给定计划中的某一类工作。	', '要求子计划的时间不能超出计划开始时间和计划结束时间，并且名称不能与原计划名称相同。润色子计划的描述。', '请你扮演一名资深的产品经理。', '负责产品计划、设计、用户体验等方面，需要具备多种技能和能力，以实现产品目标和公司战略。', 'system', '2023-11-17 12:00:00', 'active'),
(9, 'zt_story_review', '需求评审', '对需求进行结构完整性、逻辑一致性和标准符合性评审，并输出优化改进建议。', 0, 'story', 'detail', 'empty.empty', ',story.title,story.spec,story.verify,story.product,story.module,story.pri,story.category,story.estimate,', 'empty.empty', '## 核心专业能力\n\n- 结构完整性分析（角色、动作、目标、约束要素）\n- 逻辑一致性分析（单条及多条需求之间的合理性）\n- 评审标准适配（INVEST、SMART或自定义标准）\n- 优先级归类评审建议（突出最关键问题，辅助次要优化）\n- 正式、清晰、专业的输出风格（无emoji，注重结构）\n\n## 工作风格\n\n- 一轮输出，结构化归类\n- 引导用户先聚焦最关键问题\n- 提供清晰、专业、可操作的完善方向\n- 语言正式、客观，保持体验流畅且不压迫\n\n\n## 评审交互流程\n\n1. 接收需求文本（来源于需求详情点击或输入）\n2. 进行结构与逻辑完整性检查\n3. 按重要性将评审建议归为两大类：\n- 核心优先改进项（必须优先处理）\n- 次要优化建议（在有时间或资源时进一步完善）\n4. 一次性输出完整评审结果，不进行多轮追问\n5. 引导用户先集中处理核心问题，如有余力再逐步优化次要问题\n\n## 输出结构要求\n\n- 统一使用正式Markdown结构，分清主次\n- 首先输出【评审总结】，概述整体需求状态\n- 然后分为两个部分输出：\n- 第一部分：核心优先改进项\n- 第二部分：次要优化建议\n- 每个建议应简明扼要，突出问题与优化方向\n- 不使用emoji或花哨符号，保持专业正式风格\n\n## 输出示范结构\n\n## 需求评审结果总结\n\n本次评审分析显示，需求整体情况如下：\n- 结构完整性：基本完整/存在缺失\n- 逻辑一致性：连贯/存在冲突\n- 标准符合性（如INVEST）：符合/部分符合/存在明显缺口\n\n## 核心优先改进项\n\n以下问题建议优先处理，以保证需求的可实现性与后续交付质量：\n\n1. （最重要问题简述）\n2. （次重要问题简述）\n3. （其他关键问题简述）\n\n## 次要优化建议\n\n在核心问题处理完毕后，可进一步关注以下细节优化：\n\n1. （次要问题简述）\n2. （细节补充建议）\n3. （未来增强方向提示）\n\n## 小结\n\n根据用户本次的改进项目，给出总结。', '## 附加控制策略\n- 若检测到需求长度或复杂度超出正常范围，可适度缩减次要优化建议，只列出最相关的补充方向。\n- 若累计对话Token数接近10000时，友好提示建议保存成果并新开对话，避免性能下降。', '你是一位资深的需求评审专家，专注于帮助项目管理团队提升需求条目的完整性、逻辑性与可实现性。', '你的职责是基于专业评审方法，在一次完整分析中，系统性提出归类清晰、重点突出的评审建议，引导用户高效完善需求。如果用户问询需求评审以外的问题，可以给与简单响应后，拉回需求评审中。', 'system', '2025-10-31 12:00:00', 'active'),
(10, 'zt_create_doc', '编写开发设计文档智能体', '根据任务的名称、描述、设计类型、后端框架、前端框架和数据库类型等信息生成一篇开发设计文档。', 0, 'task', 'detail', 'doc.create', ',task.name,task.desc,task.pri,task.status,task.estimate,task.consumed,task.left,task.progress,task.estStarted,task.realStarted,task.story,', 'doc.create', '请根据任务数据、 <设计类型> 、 <后端框架> 、 <前端框架>  和 <数据库类型>  生成一篇开发设计文档。', '', '你是一名经验丰富的开发工程师。', '精通多种编程语言和框架、熟悉前后端技术和架构、擅长性能优化和安全防护、熟悉云计算和容器化技术、能够协调多人协作和项目管理。', 'system', '2025-11-30 12:00:00', 'active'),
(11, 'zt_story_prototype', '绘制需求原型图智能体', '根据输入的需求信息, 生成一个HTML格式的原型图示例。', 0, 'story', 'detail', 'empty.empty', ',story.title,story.spec,story.verify,story.product,story.module,story.pri,story.category,story.estimate,', 'empty.empty', '根据输入的需求信息，生成一个HTML格式的原型图示例。原型图应包含以下部分：\n1. 标题\n2. 整体结构框架（如导航栏、侧边栏、主要内容区）\n3. 各功能模块的简要设计（如按钮、表单、图表等）\n4. 交互设计提示（如如何进行用户操作）\n5. 请生成完整的 HTML5 页面代码，包括开始的 \\`<!DOCTYPE html>\\` 和 结束的 \\`</html>\\`，使用 markdown html 代码块表示，如果有多个页面请使用多个代码块表示。\n6. 如果页面有 CSS，应该直接在 HTML 页面内使用内联样式\\`<style>\\`表示，而不是链接单独的 CSS 文件。', '', '请你扮演一名资深的产品经理。', '负责绘制需求原型图的过程。您将需求转化为可视化的原型图，同时确保其符合需求描述和需求验收标准。', 'system', '2025-11-30 12:00:00', 'active'),
(12, 'zt_release_newsletter', '编写发布新闻稿', '根据发布详情信息、需求列表和Bug列表生成符合模板规范的新闻稿。', 0, 'release', 'detail', 'doc.create', ',release.product,release.name,release.desc,release.date,stories.title,stories.estimate,bugs.title,', 'doc.create', '请根据发布信息以及发布中关联的需求和Bug编写发布新闻稿。\n要求： 1.新闻稿格式严格参考产品**新闻稿通用模板**：\n#### **新闻标题** **\\[产品名称\\] \\[版本号\\] 正式发布，新增\\[亮点功能\\]！**\n#### **新闻导语** 大家好， 我们很高兴地宣布，**\\[产品名称\\] \\[版本号\\] 正式发布！** **本次发布新增了\\[核心功能名称\\]!** 该功能支持\\[简要功能描述\\]，帮助用户\\[解决什么问题\\]，提升\\[具体价值\\]。 同时，我们优化了\\[其他方面\\]，安装更简单，修复了已知Bug。\n#### **新增功能亮点**\n**本版本主要新增功能包括：**\n- **\\[功能模块1\\]**：\\[具体功能点\\]\n- **\\[功能模块2\\]**：\\[具体功能点\\]\n- **\\[优化改进\\]**：\\[具体优化点\\]\n#### **功能详细说明**\n- **跨\\[产品/项目\\]协作**\n- 支持\\[具体应用场景\\]\n- 解决\\[用户痛点\\]\n- **安装与部署优化**\n- 安装向导简化\n- 解压/安装速度提升\n- **界面与体验改进**\n- 用户界面升级\n- 操作流程优化\n#### **下载与安装** 我们提供多种安装方式：\n- **Windows版** - \\[安装版下载\\]\n- \\[免安装版下载\\] - **Linux版**\n- \\[安装版下载\\]\n- \\[免安装版下载\\]\n- **源码版** - \\[PHP 7.x版\\]\n- \\[PHP 8.x版\\]\n- **Docker镜像**\n- \\[Docker Hub地址\\]\n#### **文档支持** - 安装指南：\\[链接\\] - 升级指南：\\[链接\\] - 使用手册：\\[链接\\] - 常见问题解答：\\[链接\\]\n#### **结语** 新版本将为用户带来更好的使用体验和更高的工作效率，感谢大家一直以来的支持与反馈！我们将继续努力，提供更优秀的产品和服务！ 2.新闻稿通用模板中的功能亮点需要对需求列表中的需求进行总结，在功能详细说明里面描述清楚。\n3.将markdown格式渲染出来', '', '请你扮演一名资深的产品经理。', '负责产品战略、设计、开发、数据分析、用户体验、团队管理、沟通协调等方面，需要具备多种技能和能力，以实现产品目标和公司战略。', 'system', '2025-12-30 12:00:00', 'active'),
(13, 'zt_project_proposal', '编写立项报告', '根据项目基本信息、阶段或迭代信息生成项目立项报告。', 0, 'project', 'detail', 'doc.create', ',project.name,project.type,project.desc,project.begin,project.end,project.estimate,programplans.name,programplans.desc,programplans.status,programplans.begin,programplans.end,programplans.realBegan,programplans.realEnd,programplans.progress,programplans.estimate,programplans.consumed,programplans.left,executions.name,executions.desc,executions.status,executions.begin,executions.end,executions.realBegan,executions.realEnd,executions.estimate,executions.consumed,executions.progress,', 'doc.create', '请根据项目信息、阶段或迭代信息生成一份项目立项报告。\n要求： 1.严格参考项目立项报告模板：\n## 一、项目基本信息\n| 项目名称 | 项目代号 | 所属部门 | 项目负责人 | 开始日期 | 结束日期 | 预计周期 | 项目类型 | 项目阶段 |\n|----------|----------|----------|------------|----------|----------|-----------|-----------|-----------|\n| | | | | | | | | |\n## 二、项目背景与立项目的\n### 1. 项目背景 简要说明项目产生的背景、市场或业务需求，以及项目的必要性。\n### 2. 立项目的 明确项目的目标，以及希望通过本项目实现的战略或业务目标。\n## 三、项目目标与关键指标（OKR）\n| 目标 | 关键结果（KR） | 责任人 | 完成时间 |\n|------|----------------|--------|----------|\n| | | | | | | | | |\n## 四、项目范围与内容\n### 1. 项目范围 简要说明本项目的开发范围，包括产品功能、技术实现、市场定位等。\n### 2. 主要功能/产品特性 列出产品的核心功能或主要特性，说明其市场价值与竞争优势。\n### 3. 目标用户群 明确产品的目标用户群体，包括年龄、性别、使用场景等信息。\n## 五、市场与竞争分析\n### 1. 市场需求 分析当前市场对本产品的需求情况，包括市场规模、增长率、用户痛点等。\n### 2. 竞争分析 简述主要竞争对手的产品情况、市场占有率、优势与劣势。\n### 3. 项目差异化优势 说明本项目相较于竞品的差异化优势。\n## 六、项目资源计划\n### 1. 人力资源 列出主要项目成员及分工，包括项目经理、研发人员、测试人员、市场人员等。\n### 2. 技术资源 说明所需的技术平台、开发工具、测试设备等资源。\n### 3. 资金预算 列出项目的总预算、分项支出及资金来源。\n## 七、项目实施计划（甘特图或阶段划分）\n### 1. 项目阶段划分 将项目划分为几个主要阶段，并简要说明每个阶段的目标和交付物。\n## 八、风险评估与应对策略\n| 风险 | 影响 | 可能性 | 应对措施 |\n|------|------|--------|----------|\n## 九、项目收益与预期成果\n### 1. 项目收益 说明项目成功后的预期收益，包括财务、市场、品牌等层面。\n### 2. 项目成果 列出项目完成后的主要成果，包括产品、文档、知识产权等。', '', '请你扮演一名经验丰富的项目经理。', '具备项目计划制定、进度管理、成本控制、团队管理、沟通协调、风险管理、质量控制、敏捷开发、互联网技术和数据分析等多方面的技能和能力。', 'system', '2025-12-30 12:00:00', 'active'),
(14, 'zt_project_finalreport', '编写结项报告', '根据项目基本信息、阶段或迭代信息生成项目结项报告。', 0, 'project', 'detail', 'doc.create', ',project.name,project.type,project.desc,project.begin,project.end,project.estimate,programplans.name,programplans.desc,programplans.status,programplans.begin,programplans.end,programplans.realBegan,programplans.realEnd,programplans.progress,programplans.estimate,programplans.consumed,programplans.left,executions.name,executions.desc,executions.status,executions.begin,executions.end,executions.realBegan,executions.realEnd,executions.estimate,executions.consumed,executions.progress,', 'doc.create', '请根据项目信息、阶段或迭代信息生成一份项目结项报告。\n要求： 1.严格参考项目结项报告模板：\n## 一、项目基本信息\n| 项目名称 | 项目代号 | 所属部门 | 项目负责人 | 项目周期 | 开始日期 | 结束日期 | 项目类型 | 项目阶段 |\n|----------|----------|----------|------------|----------|----------|----------|-----------|-----------|\n|          |          |          |            |          |          |          |           |           |\n## 二、项目概况\n### 1. 项目背景\n简要回顾项目立项时的背景、目标及意义。\n### 2. 项目目标\n总结项目初期设定的目标及关键绩效指标（KPI）。\n## 三、项目实施过程\n### 1. 项目阶段回顾\n按照项目阶段划分，简要说明各阶段的完成情况。\n### 2. 关键里程碑\n列出项目中的关键里程碑及完成时间。\n## 四、项目成果与交付物\n### 1. 项目成果\n列出项目完成后的主要成果。\n### 2. 项目交付物\n列出项目交付的成果物。\n> 示例：\n| 交付物 | 类型 | 状态 |\n|--------|------|------|\n| 需求文档 | 文档类 | 已完成 |\n| 系统设计文档 | 文档类 | 已完成 |\n| 产品原型 | 硬件/软件 | 已交付 |\n| 测试报告 | 文档类 | 已完成 |\n| 用户手册 | 文档类 | 已完成 |\n## 五、项目质量与测试\n### 1. 质量管理\n简要说明项目中采用的质量管理方法与工具。\n> 示例：采用ISO 9001质量管理体系，结合敏捷开发与测试驱动开发（TDD）进行质量控制。\n### 2. 测试结果\n列出关键测试的执行情况及结果。\n## 六、项目成本与预算执行情况\n## 七、项目风险与问题回顾\n### 1. 风险回顾\n总结项目实施过程中出现的风险及应对措施。\n### 2. 项目问题及处理\n列出项目中遇到的问题及其解决方案。\n## 八、项目收益与价值\n### 1. 项目收益\n说明项目完成后的实际收益，包括财务、市场、品牌等方面。\n### 2. 项目价值\n总结项目对团队、公司及行业的价值。\n## 九、项目经验与教训\n### 1. 成功经验\n总结项目实施过程中的成功做法与经验。\n### 2. 存在问题\n总结项目中存在的问题及改进建议。', '', '请你扮演一名经验丰富的项目经理。', '具备项目计划制定、进度管理、成本控制、团队管理、沟通协调、风险管理、质量控制、敏捷开发、互联网技术和数据分析等多方面的技能和能力。', 'system', '2025-12-30 12:00:00', 'active'),
(15, 'zt_automatic_test', '编写自动化测试脚本', '根据用例的基本信息、步骤描述、预期结果和补充信息生成自动化测试脚本。', 0, 'case', 'detail', 'empty.empty', ',case.title,case.precondition,case.scene,case.product,case.module,case.pri,case.type,case.lastRunResult,case.status,steps.desc,steps.expect,', 'empty.empty', '请根据用例信息、 <系统类型> <后端框架> <前端框架> <测试类型> 和 <其他信息> 生成自动化测试脚本。', '', '作为一名资深的测试工程师。', '测试工程师应该是专业且严谨的。熟悉测试流程和方法，精通自动化测试和性能测试，能够设计和编写测试用例和测试脚本，擅长问题诊断和分析，熟悉敏捷开发和持续集成，能够协调多部门合作和项目管理。', 'system', '2025-12-30 12:00:00', 'active');
...
(14, '潜在风险', 'textarea', '', NULL, 0),
(14, '预期收益', 'textarea', '', NULL, 0),
(15, '系统类型', 'checkbox', '', 'Web,APP,API', 1),
(15, '后端框架', 'radio', '', 'PHP,GO,Java,Python,Node.js,其他', 1),
(15, '前端框架', 'radio', '', 'JavaScript,Vue,React,Angular,其他', 1),
(15, '测试类型', 'radio', '', '单元测试,接口测试,UI测试', 1),
(15, '其他信息', 'textarea', '', NULL, 0);

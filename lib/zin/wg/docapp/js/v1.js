...
const actionsMap =
{
    ...
    'doc-edit': function(info)
    {
        ...
        const moreItems = [];
        const docApp = this;
        const {useHocuspocus} = docApp.props;
        const hocuspocusEnabled = typeof useHocuspocus === 'function' ? useHocuspocus(docApp) : !!useHocuspocus;
        const canImport = !hocuspocusEnabled || doc.status === 'draft';

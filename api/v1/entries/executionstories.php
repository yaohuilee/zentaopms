...
class executionStoriesEntry extends entry
{
    ...
    public function get($executionID)
    {
        ...
        $control->story((int)$executionID, $this->param('storyType', 'story'), $this->param('order', 'id_desc'), $this->param('status', 'all'), 0, 0, (int)$this->param('limit', 20), (int)$this->param('page', 1));
        $data = $this->getData();

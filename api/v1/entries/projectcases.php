...
class projectCasesEntry extends entry
{
    ...
    public function get($projectID = 0)
    {
        ...
        $control->testcase((int)$projectID, (int)$this->param('product', 0), $this->param('branch', 'all'), $this->param('status', 'all'), 0, $this->param('caseType', ''), $this->param('order', 'id_desc'), 0, (int)$this->param('limit', 20), (int)$this->param('page', 1));

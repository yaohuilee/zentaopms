...
class releasesEntry extends entry
{
    ...
    public function get($productID = 0)
    {
        ...
        $control->browse((int)$productID, $this->param('branch', 'all'), $this->param('status', 'all'), $this->param('order', 't1.date_desc'), '', 0, (int)$this->param('limit', 20), (int)$this->param('page', 1));

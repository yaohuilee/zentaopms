...
- 查询objectTypes的key值 @product,epic,requirement,story,productplan,release,build,project,execution,task,bug,case,testtask,todo,doc
- 查询objectTypes的value值 @产品,业务需求,用户需求,研发需求,计划,发布,构建,项目,执行,任务,Bug,用例,测试单,待办,文档
...
r(implode(',', array_slice(array_keys($objectTypes), 0, 15)))   && p() && e('product,epic,requirement,story,productplan,release,build,project,execution,task,bug,case,testtask,todo,doc'); //查询objectTypes的key值
r(implode(',', array_slice(array_values($objectTypes), 0, 15))) && p() && e('产品,业务需求,用户需求,研发需求,计划,发布,构建,项目,执行,任务,Bug,用例,测试单,待办,文档');                     //查询objectTypes的value值

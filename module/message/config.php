...
$config->message->objectTypes['build']       = array('opened', 'edited', 'deleted', 'mentioned');
...
$config->message->available['mail']['case']        = array('mentioned');
...
$config->message->available['message']['build']       = $config->message->objectTypes['build'];
...
$config->message->available['message']['case']        = array('mentioned');

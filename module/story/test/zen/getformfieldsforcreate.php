...
try { ob_start(); $result = callZenMethod('story', 'getFormFieldsForCreate', array(1, '1', 1, (object)array(), 'story')); $echoed = ob_get_clean(); if($echoed !== '') $result = 'echo_yes'; if(dao::isError()) $result = 'daoError:' . json_encode(dao::getError(), JSON_UNESCAPED_UNICODE); } catch(Throwable $e) { if(ob_get_level()) ob_end_clean(); if($e instanceof EndResponseException) $result = 0; else $result = 'error:' . get_class($e); }
r(count($result)) && p() && e('30'); // 步骤1：正常输入
try { ob_start(); $result = callZenMethod('story', 'getFormFieldsForCreate', array(0, '1', 1, (object)array(), 'story')); $echoed = ob_get_clean(); if($echoed !== '') $result = 'echo_yes'; if(dao::isError()) $result = 'daoError:' . json_encode(dao::getError(), JSON_UNESCAPED_UNICODE); } catch(Throwable $e) { if(ob_get_level()) ob_end_clean(); if($e instanceof EndResponseException) $result = 0; else $result = 'error:' . get_class($e); }
r(count($result)) && p() && e('30'); // 步骤2：边界值输入
try { ob_start(); $result = callZenMethod('story', 'getFormFieldsForCreate', array(-1, '1', 1, (object)array(), 'story')); $echoed = ob_get_clean(); if($echoed !== '') $result = 'echo_yes'; if(dao::isError()) $result = 'daoError:' . json_encode(dao::getError(), JSON_UNESCAPED_UNICODE); } catch(Throwable $e) { if(ob_get_level()) ob_end_clean(); if($e instanceof EndResponseException) $result = 0; else $result = 'error:' . get_class($e); }
r(count($result)) && p() && e('30'); // 步骤3：无效输入
try { ob_start(); $result = callZenMethod('story', 'getFormFieldsForCreate', array(999999, '1', 1, (object)array(), 'story')); $echoed = ob_get_clean(); if($echoed !== '') $result = 'echo_yes'; if(dao::isError()) $result = 'daoError:' . json_encode(dao::getError(), JSON_UNESCAPED_UNICODE); } catch(Throwable $e) { if(ob_get_level()) ob_end_clean(); if($e instanceof EndResponseException) $result = 0; else $result = 'error:' . get_class($e); }
r(count($result)) && p() && e('30'); // 步骤4：大值输入
try { ob_start(); $result = callZenMethod('story', 'getFormFieldsForCreate', array(2, 'test', 1, (object)array(), 'story')); $echoed = ob_get_clean(); if($echoed !== '') $result = 'echo_yes'; if(dao::isError()) $result = 'daoError:' . json_encode(dao::getError(), JSON_UNESCAPED_UNICODE); } catch(Throwable $e) { if(ob_get_level()) ob_end_clean(); if($e instanceof EndResponseException) $result = 0; else $result = 'error:' . get_class($e); }
r(count($result)) && p() && e('30'); // 步骤5：业务规则验证

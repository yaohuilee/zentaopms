...
$config->stakeholder->dtable->fieldList['nature']['group'] = 4;
...
$config->stakeholder->dtable->fieldList['analysis']['group'] = 5;
...
$config->stakeholder->dtable->fieldList['strategy']['group'] = 6;
...
$config->stakeholder->dtable->fieldList['phone']['group'] = 7;
...
$config->stakeholder->dtable->fieldList['qq']['group'] = 8;
...
$config->stakeholder->dtable->fieldList['weixin']['group'] = 9;
...
$config->stakeholder->dtable->fieldList['email']['group'] = 10;
...
$config->stakeholder->dtable->fieldList['actions']['group']    = 11;

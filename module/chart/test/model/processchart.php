...
- 步骤1：正常输入 @object_count=6
- 步骤2：边界值输入 @object_count=6
- 步骤3：无效输入 @object_count=6
- 步骤4：大值输入 @id=999999
- 步骤5：业务规则验证 @id=1

*/

r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->processChart((object)array()); }))) && p() && e('object_count=6'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->processChart((object)array()); }))) && p() && e('object_count=6'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->processChart((object)array()); }))) && p() && e('object_count=6'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->processChart((object)array('id' => 999999)); }))) && p() && e('id=999999'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->processChart((object)array('id' => 1, 'name' => 'test')); }))) && p() && e('id=1'); // 步骤5：业务规则验证

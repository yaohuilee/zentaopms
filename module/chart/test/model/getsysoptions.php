...
$result = $testObj->getSysOptionsTest('1', '', '', '', '', 'mysql');
r(count($result)) && p() && e('0'); // 步骤1：正常输入
$result = $testObj->getSysOptionsTest('', '', '', '', '', 'mysql');
r(count($result)) && p() && e('0'); // 步骤2：边界值输入
$result = $testObj->getSysOptionsTest('abc', '', '', '', '', 'mysql');
r(count($result)) && p() && e('0'); // 步骤3：无效输入
$result = $testObj->getSysOptionsTest('999999', '', '', '', '', 'mysql');
r(count($result)) && p() && e('0'); // 步骤4：大值输入
$result = $testObj->getSysOptionsTest('test', 'test', '', '', '', 'mysql');

...
r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->checkAccess(1, 'preview'); }))) && p() && e('error:Error'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->checkAccess(0, 'preview'); }))) && p() && e('error:Error'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->checkAccess('abc', 'preview'); }))) && p() && e('error:Error'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->checkAccess(999999, 'preview'); }))) && p() && e('error:Error'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->checkAccess('test', 'test'); }))) && p() && e('error:Error'); // 步骤5：业务规则验证

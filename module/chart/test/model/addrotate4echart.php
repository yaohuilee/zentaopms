...
- 步骤3：无效输入 @array:-1
- 步骤4：大值输入 @array:999999
- 步骤5：业务规则验证 @array:1,2

*/

r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->addRotate4Echart(array(), array(), '1'); }))) && p() && e('empty_array'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->addRotate4Echart(array(), array(), '1'); }))) && p() && e('empty_array'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->addRotate4Echart(array(-1), array(), '1'); }))) && p() && e('array:-1'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->addRotate4Echart(array(999999), array(), '1'); }))) && p() && e('array:999999'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->addRotate4Echart(array(1, 2), array(1, 2), '1'); }))) && p() && e('array:1,2'); // 步骤5：业务规则验证

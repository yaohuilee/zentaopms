...
r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->addFormatter4Echart(array(), '1'); }))) && p() && e('empty_array'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->addFormatter4Echart(array(), '1'); }))) && p() && e('empty_array'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->addFormatter4Echart(array(-1), '1'); }))) && p() && e('array:-1'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->addFormatter4Echart(array(999999), '1'); }))) && p() && e('array:999999'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->chart->addFormatter4Echart(array(1, 2), 'test'); }))) && p() && e('array:1,2'); // 步骤5：业务规则验证

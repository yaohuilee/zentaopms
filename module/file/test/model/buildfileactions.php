...
$result2 = $fileTester->buildFileActionsTest($fileIdList[1], $showEdit[0], $showDeleteList[1]);
$result3 = $fileTester->buildFileActionsTest($fileIdList[2], $showEdit[1], $showDeleteList[0]);
$result4 = $fileTester->buildFileActionsTest($fileIdList[3], $showEdit[0], $showDeleteList[1]);

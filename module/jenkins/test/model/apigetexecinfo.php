...
title=测试 jenkinsModel::apiGetExecInfo()
timeout=0
cid=0
...
r(ztfVal(ztfCall(function() use ($tester) { return $tester->jenkins->apiGetExecInfo(1, '1', (object)array()); }))) && p() && e('empty_array'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->jenkins->apiGetExecInfo(0, '1', (object)array()); }))) && p() && e('empty_array'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->jenkins->apiGetExecInfo(-1, '1', (object)array()); }))) && p() && e('empty_array'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->jenkins->apiGetExecInfo(999999, '1', (object)array()); }))) && p() && e('empty_array'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->jenkins->apiGetExecInfo(2, 'test', (object)array()); }))) && p() && e('empty_array'); // 步骤5：业务规则验证

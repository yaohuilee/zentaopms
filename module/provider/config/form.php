...
$config->provider->form->create['createdDate'] = array('type' => 'string', 'required' => false, 'default' => $now);

$config->provider->form->edit = $config->provider->form->create;
$config->provider->form->create['editedDate'] = array('type' => 'string', 'required' => false, 'default' => $now);

...
title=测试 runnerModel::deleteRunner()
timeout=0
cid=0
...
r(ztfVal(ztfCall(function() use ($tester) { return $tester->runner->deleteRunner(1, 1); }))) && p() && e('1'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->runner->deleteRunner(0, 1); }))) && p() && e('1'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->runner->deleteRunner(-1, 1); }))) && p() && e('1'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->runner->deleteRunner(999999, 1); }))) && p() && e('1'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->runner->deleteRunner(2, 2); }))) && p() && e('1'); // 步骤5：业务规则验证

...
r(ztfVal(ztfCall(function() use ($tester) { return $tester->runner->update(1, (object)array()); }))) && p() && e('error:EndResponseException'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->runner->update(0, (object)array()); }))) && p() && e('error:EndResponseException'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->runner->update(-1, (object)array()); }))) && p() && e('error:EndResponseException'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->runner->update(999999, (object)array()); }))) && p() && e('error:EndResponseException'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->runner->update(2, (object)array('id' => 1, 'name' => 'test')); }))) && p() && e('1'); // 步骤5：业务规则验证

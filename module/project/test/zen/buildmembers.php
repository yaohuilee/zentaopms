...
- 步骤1：正常输入 @array_count=5
- 步骤2：边界值输入 @array_count=5
...
r(ztfVal(ztfCall(function() use ($tester) { return callZenMethod('project', 'buildMembers', array(array(), array(), array(), 1)); }))) && p() && e('array_count=5'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return callZenMethod('project', 'buildMembers', array(array(), array(), array(), 1)); }))) && p() && e('array_count=5'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return callZenMethod('project', 'buildMembers', array(array(-1), array(), array(), 1)); }))) && p() && e('error:Error'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return callZenMethod('project', 'buildMembers', array(array(999999), array(), array(), 1)); }))) && p() && e('error:Error'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return callZenMethod('project', 'buildMembers', array(array(1, 2), array(1, 2), array(), 1)); }))) && p() && e('error:Error'); // 步骤5：业务规则验证

...
$lang->gitfox->deleteTagFail        = "标签删除失败";
...
$lang->gitfox->devopsIntroduction = '禅道DevOps解决方案：全面重构，智领未来';
$lang->gitfox->devopsDescription  = <<<EOD
<p class="leading-relaxed mb-2 font-bold">
  DevOps 4.0底层能力由GitFox引擎提供。GitFox 是一款纯自研的，专注于企业研发协同的Git源代码管理平台 ，提供从代码托管、流水线构建，到质量扫描、制品管理的一站式能力，旨在帮助企业高效CI&CD。
</p>
EOD;

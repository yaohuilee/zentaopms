...
$result = $testObj->httpTest('http://127.0.0.1:1/', null, array(), array(), 'data', 'POST', 1, false, true);
...
$result = $testObj->httpTest('http://127.0.0.1:1/', 'test', array(), array(), 'data', 'POST', 1, false, true);

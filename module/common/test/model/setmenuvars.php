...
$result = $testObj->setMenuVarsTest('1', 1, array());
r($result === null) && p() && e('1'); // 步骤1：正常输入
$result = $testObj->setMenuVarsTest('', 1, array());
r($result === null) && p() && e('1'); // 步骤2：边界值输入
$result = $testObj->setMenuVarsTest('abc', 1, array());
r($result === null) && p() && e('1'); // 步骤3：无效输入
$result = $testObj->setMenuVarsTest('999999', 1, array());
r($result === null) && p() && e('1'); // 步骤4：大值输入
$result = $testObj->setMenuVarsTest('test', 2, array());

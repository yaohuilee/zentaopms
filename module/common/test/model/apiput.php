...
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->common, 'apiPut', array('http://127.0.0.1:1/', array(), array())); }))) && p() && e('code=600'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->common, 'apiPut', array('http://127.0.0.1:1/', array(), array())); }))) && p() && e('code=600'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->common, 'apiPut', array('http://127.0.0.1:1/', array(), array())); }))) && p() && e('code=600'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->common, 'apiPut', array('http://127.0.0.1:1/', array(), array())); }))) && p() && e('code=600'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->common, 'apiPut', array('http://127.0.0.1:1/', array(1, 2), array())); }))) && p() && e('code=600'); // 步骤5：业务规则验证

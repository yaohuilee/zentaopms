...
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->common, 'printIcon', array(1, 1, '', '', 'button', '', '', '', false, '', '', 0, '')); }))) && p() && e('error:TypeError'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->common, 'printIcon', array(0, 1, '', '', 'button', '', '', '', false, '', '', 0, '')); }))) && p() && e('error:TypeError'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->common, 'printIcon', array('abc', 1, '', '', 'button', '', '', '', false, '', '', 0, '')); }))) && p() && e('error:TypeError'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->common, 'printIcon', array(999999, 1, '', '', 'button', '', '', '', false, '', '', 0, '')); }))) && p() && e('error:TypeError'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->common, 'printIcon', array('test', 'test', '', '', 'button', '', '', '', false, '', '', 0, '')); }))) && p() && e('null'); // 步骤5：业务规则验证

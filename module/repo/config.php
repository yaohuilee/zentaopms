...
$config->repo->program = new stdclass();
$config->repo->program->suffix['c']    = "cpp";
$config->repo->program->suffix['cpp']  = "cpp";
$config->repo->program->suffix['asp']  = "asp";
$config->repo->program->suffix['php']  = "php";
$config->repo->program->suffix['cs']   =  "cs";
$config->repo->program->suffix['sh']   = "bash";
$config->repo->program->suffix['jsp']  = "java";
$config->repo->program->suffix['lua']  = "lua";
$config->repo->program->suffix['sql']  = "sql";
$config->repo->program->suffix['js']   = "javascript";
$config->repo->program->suffix['ini']  = "ini";
$config->repo->program->suffix['conf'] = "apache";
$config->repo->program->suffix['bat']  = "dos";
$config->repo->program->suffix['py']   = "python";
$config->repo->program->suffix['rb']   = "ruby";
$config->repo->program->suffix['as']   = "actionscript";
$config->repo->program->suffix['html'] = "xml";
$config->repo->program->suffix['xml']  = "xml";
$config->repo->program->suffix['htm']  = "xml";
$config->repo->program->suffix['pl']   = "perl";

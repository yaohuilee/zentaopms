...
title=测试 repoModel::loadMaintainSpacePrivs()
timeout=0
cid=0
...
r(ztfVal(ztfCall(function() use ($tester) { return $tester->repo->loadMaintainSpacePrivs(array()); }))) && p() && e('null'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->repo->loadMaintainSpacePrivs(array()); }))) && p() && e('null'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->repo->loadMaintainSpacePrivs(array(-1)); }))) && p() && e('null'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->repo->loadMaintainSpacePrivs(array(999999)); }))) && p() && e('null'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->repo->loadMaintainSpacePrivs(array(1, 2)); }))) && p() && e('null'); // 步骤5：业务规则验证

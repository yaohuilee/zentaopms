...
$result = $testObj->getUserForJSONTest((object)array());
...
r($testObj->getUserForJSONTest((object)array('id' => 999999))) && p('id') && e('999999'); // 步骤4：大值输入
r($testObj->getUserForJSONTest((object)array('id' => 1, 'name' => 'test'))) && p('id') && e('1'); // 步骤5：业务规则验证

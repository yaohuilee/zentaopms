...
$result = $testObj->printScrumListBlockTest((object)array());
r($result === null) && p() && e('1'); // 步骤1：正常输入
$result = $testObj->printScrumListBlockTest((object)array());
r($result === null) && p() && e('1'); // 步骤2：边界值输入
$result = $testObj->printScrumListBlockTest((object)array());
r($result === null) && p() && e('1'); // 步骤3：无效输入
$result = $testObj->printScrumListBlockTest((object)array('id' => 999999));
r($result === null) && p() && e('1'); // 步骤4：大值输入
$result = $testObj->printScrumListBlockTest((object)array('id' => 1, 'name' => 'test'));

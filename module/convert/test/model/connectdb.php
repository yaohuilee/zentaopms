...
- 步骤1：正常输入 @object_count=1
- 步骤2：边界值输入 @object_count=1
...
r(ztfVal(ztfCall(function() use ($tester) { return $tester->convert->connectDB(''); }))) && p() && e('object_count=1'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->convert->connectDB(''); }))) && p() && e('object_count=1'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->convert->connectDB('abc'); }))) && p() && e('SQLSTATE[HY000] [1049] Unknown database abc'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->convert->connectDB('999999'); }))) && p() && e('SQLSTATE[HY000] [1049] Unknown database 999999'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->convert->connectDB('test'); }))) && p() && e('SQLSTATE[HY000] [1049] Unknown database test'); // 步骤5：业务规则验证

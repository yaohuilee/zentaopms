...
$config->testsuite->form->create['addedBy']   = array('required' => false, 'type' => 'string',   'default' => $account);
$config->testsuite->form->create['addedDate'] = array('required' => false, 'type' => 'datetime', 'default' => $now);
...
$config->testsuite->form->edit['lastEditedBy']   = array('required' => false, 'type' => 'string',   'default' => $account);
$config->testsuite->form->edit['lastEditedDate'] = array('required' => false, 'type' => 'datetime', 'default' => $now);

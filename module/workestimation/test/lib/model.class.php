...
class workestimationModelTest extends baseTest
{
    protected $moduleName = 'workestimation';
     ...
     * @return mixed
     */
    public function getBudgetTest(...$args)
    {
        try
        {
            ob_start();
            $result = $this->invokeArgs('getBudget', $args);
            $echoed = ob_get_clean();

...
- 获取执行任务列表所属项目、所属执行字段，默认不勾选
 - 第projectName条的title属性 @所属项目
 - 第projectName条的show属性 @~~
 - 第executionName条的title属性 @所属执行
 - 第executionName条的show属性 @~~
...
r($datatable->getFieldListTest('execution', 'task'))  && p('projectName:title,show;executionName:title,show') && e('所属项目,~~,所属执行,~~'); //获取执行任务列表所属项目、所属执行字段，默认不勾选

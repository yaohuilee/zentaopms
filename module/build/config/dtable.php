...
$config->build->bug->dtable = clone $config->bug->dtable;
$config->build->bug->dtable->defaultField = array('id', 'title', 'severity', 'pri', 'status', 'openedBy', 'openedDate', 'resolvedBy', 'resolvedDate', 'actions');
foreach($config->build->bug->dtable->fieldList as $field => $fieldConfig)
{
    $config->build->bug->dtable->fieldList[$field]['show'] = in_array($field, $config->build->bug->dtable->defaultField);
}
$config->build->bug->dtable->fieldList['id']['sortType']       = false;
$config->build->bug->dtable->fieldList['resolvedDate']['show'] = true;
$config->build->bug->dtable->fieldList['resolvedBy']['show']   = true;
...
$config->build->bug->dtable->fieldList['actions']['width']     = 80;
$config->build->bug->dtable->fieldList['actions']['minWidth']  = 80;

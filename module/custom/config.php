...
$config->custom->fieldList['execution']['create']    = 'days,products,plans,desc,PO,PM,QD,RD';
$config->custom->fieldList['execution']['edit']      = 'days,products,plans,desc,PO,PM,QD,RD';
...
$config->custom->fieldList['testtask']['create']     = 'owner,type,members,pri,desc';
$config->custom->fieldList['testtask']['edit']       = 'owner,type,members,pri,desc';
$config->custom->fieldList['testtask']['importUnit'] = 'owner,pri,desc';

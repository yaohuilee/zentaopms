...
$config->pipeline->form->flowInfo['createdDate'] = array('type' => 'string', 'required' => false, 'default' => $now);
$config->pipeline->form->flowInfo['editedDate']  = array('type' => 'string', 'required' => false, 'default' => $now);

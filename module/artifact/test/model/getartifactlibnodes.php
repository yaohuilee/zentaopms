...
r(ztfVal(ztfCall(function() use ($tester) { return $tester->artifact->getArtifactLibNodes((object)array('id' => 999999), '1'); }))) && p() && e('error:TypeError'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->artifact->getArtifactLibNodes((object)array('id' => 1, 'name' => 'test'), 'test'); }))) && p() && e('error:TypeError'); // 步骤5：业务规则验证

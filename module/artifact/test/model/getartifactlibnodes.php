...
title=测试 artifactModel::getArtifactLibNodes()
timeout=0
cid=0
...
- 步骤4：大值输入 @daoError:{"apiMessage":"指定的制品视图不存在."}
- 步骤5：业务规则验证 @daoError:{"apiMessage":"指定的制品视图不存在."}

*/

r(ztfVal(ztfCall(function() use ($tester) { return $tester->artifact->getArtifactLibNodes((object)array(), '1'); }))) && p() && e('empty_array'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->artifact->getArtifactLibNodes((object)array(), '1'); }))) && p() && e('empty_array'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->artifact->getArtifactLibNodes((object)array(), '1'); }))) && p() && e('empty_array'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->artifact->getArtifactLibNodes((object)array('id' => 999999), '1'); }))) && p() && e('daoError:{"apiMessage":"指定的制品视图不存在."}'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->artifact->getArtifactLibNodes((object)array('id' => 1, 'name' => 'test'), 'test'); }))) && p() && e('daoError:{"apiMessage":"指定的制品视图不存在."}'); // 步骤5：业务规则验证

...
$result = $testObj->getLibsByProductTest(1);
r(count($result)) && p() && e('0'); // 步骤1：正常输入
$result = $testObj->getLibsByProductTest(0);
r(count($result)) && p() && e('0'); // 步骤2：边界值输入
$result = $testObj->getLibsByProductTest(-1);
r(count($result)) && p() && e('0'); // 步骤3：无效输入
$result = $testObj->getLibsByProductTest(999999);
r(count($result)) && p() && e('0'); // 步骤4：大值输入
$result = $testObj->getLibsByProductTest(2);

...
- 测试关联需求和Bug的发布是否可以点击关联需求按钮 @1
- 测试关联需求和Bug的发布是否可以点击取消关联需求按钮 @1
- 测试关联需求和Bug的发布是否可以点击关联BUG按钮 @1
- 测试关联需求和Bug的发布是否可以点击取消关联BUG按钮 @1
- 测试关联需求和Bug的发布是否可以点击取消关联遗留BUG按钮 @1
- 测试关联需求和Bug的发布是否可以点击激活按钮 @0
- 测试关联需求和Bug的发布是否可以点击停止维护按钮 @1
- 测试关联需求和Bug的发布是否可以点击编辑按钮 @1
- 测试关联需求和Bug的发布是否可以点击通知按钮 @1
- 测试关联需求和Bug的发布是否可以点击删除按钮 @1
- 测试未关联需求和Bug的发布是否可以点击关联需求按钮 @1
- 测试未关联需求和Bug的发布是否可以点击取消关联需求按钮 @1
- 测试未关联需求和Bug的发布是否可以点击关联BUG按钮 @1
- 测试未关联需求和Bug的发布是否可以点击取消关联BUG按钮 @1
- 测试未关联需求和Bug的发布是否可以点击取消关联遗留BUG按钮 @1
- 测试未关联需求和Bug的发布是否可以点击激活按钮 @0
- 测试未关联需求和Bug的发布是否可以点击停止维护按钮 @1
- 测试未关联需求和Bug的发布是否可以点击编辑按钮 @1
- 测试未关联需求和Bug的发布是否可以点击通知按钮 @0
- 测试未关联需求和Bug的发布是否可以点击删除按钮 @1

...
$config->zahost->form->create['createdDate'] = array('required' => false, 'type' => 'date',   'default' => $now);
...
$config->zahost->form->edit['editedDate'] = array('required' => false, 'type' => 'date',   'default' => $now);

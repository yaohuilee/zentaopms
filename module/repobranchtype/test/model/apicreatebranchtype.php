...
r($testObj->apiCreateBranchTypeTest(1, (object)array())) && p() && e('daoError:{"apiMessage":"Body 参数解析失败。"}'); // 步骤1：正常输入
r($testObj->apiCreateBranchTypeTest(0, (object)array())) && p() && e('daoError:{"apiMessage":"Body 参数解析失败。"}'); // 步骤2：边界值输入
r($testObj->apiCreateBranchTypeTest(-1, (object)array())) && p() && e('daoError:{"apiMessage":"Path 参数解析失败。"}'); // 步骤3：无效输入
r($testObj->apiCreateBranchTypeTest(999999, (object)array())) && p() && e('daoError:{"apiMessage":"Body 参数解析失败。"}'); // 步骤4：大值输入
r($testObj->apiCreateBranchTypeTest(2, (object)array('id' => 1, 'name' => 'test'))) && p() && e('daoError:{"apiMessage":"Body 参数解析失败。"}'); // 步骤5：业务规则验证

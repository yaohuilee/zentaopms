...
title=测试 aiModel::getWorkflowPromptFields()
timeout=0
cid=0
...
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->ai, 'getWorkflowPromptFields', array('1', '1', true)); }))) && p() && e('empty_array'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->ai, 'getWorkflowPromptFields', array('', '1', true)); }))) && p() && e('empty_array'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->ai, 'getWorkflowPromptFields', array('abc', '1', true)); }))) && p() && e('empty_array'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->ai, 'getWorkflowPromptFields', array('999999', '1', true)); }))) && p() && e('empty_array'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->ai, 'getWorkflowPromptFields', array('test', 'test', true)); }))) && p() && e('empty_array'); // 步骤5：业务规则验证

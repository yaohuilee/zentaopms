...
$result = $testObj->getWorkflowPromptFieldsTest('1', '1', true);
r(count($result)) && p() && e('0'); // 步骤1：正常输入
$result = $testObj->getWorkflowPromptFieldsTest('', '1', true);
r(count($result)) && p() && e('0'); // 步骤2：边界值输入
$result = $testObj->getWorkflowPromptFieldsTest('abc', '1', true);
r(count($result)) && p() && e('0'); // 步骤3：无效输入
$result = $testObj->getWorkflowPromptFieldsTest('999999', '1', true);
r(count($result)) && p() && e('0'); // 步骤4：大值输入
$result = $testObj->getWorkflowPromptFieldsTest('test', 'test', true);

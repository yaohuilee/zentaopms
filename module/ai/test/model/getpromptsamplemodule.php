...
title=测试 aiModel::getPromptSampleModule()
timeout=0
cid=0
...
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->ai, 'getPromptSampleModule', array(1)); }))) && p() && e('1'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->ai, 'getPromptSampleModule', array(0)); }))) && p() && e('0'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->ai, 'getPromptSampleModule', array('abc')); }))) && p() && e('abc'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->ai, 'getPromptSampleModule', array(999999)); }))) && p() && e('999999'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return ztfInvoke($tester->ai, 'getPromptSampleModule', array('test')); }))) && p() && e('test'); // 步骤5：业务规则验证

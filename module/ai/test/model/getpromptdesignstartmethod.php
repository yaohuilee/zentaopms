...
r(ztfVal(ztfCall(function() use ($tester) { return $tester->ai->getPromptDesignStartMethod(''); }))) && p() && e('promptBasicInfo'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->ai->getPromptDesignStartMethod(''); }))) && p() && e('promptBasicInfo'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->ai->getPromptDesignStartMethod('abc'); }))) && p() && e('promptBasicInfo'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->ai->getPromptDesignStartMethod('999999'); }))) && p() && e('promptBasicInfo'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->ai->getPromptDesignStartMethod('test'); }))) && p() && e('promptBasicInfo'); // 步骤5：业务规则验证

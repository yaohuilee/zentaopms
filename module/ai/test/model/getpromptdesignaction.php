...
r(ztfVal(ztfCall(function() use ($tester) { return $tester->ai->getPromptDesignAction(1); }))) && p() && e('promptbasicinfo'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->ai->getPromptDesignAction(0); }))) && p() && e('promptbasicinfo'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->ai->getPromptDesignAction('abc'); }))) && p() && e('promptbasicinfo'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->ai->getPromptDesignAction(999999); }))) && p() && e('promptbasicinfo'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->ai->getPromptDesignAction('test'); }))) && p() && e('promptbasicinfo'); // 步骤5：业务规则验证

...
$lang->ai->prompts->actionObject    = '操作对象';
$lang->ai->prompts->actionPurpose   = '操作目的';
$lang->ai->prompts->displayPosition = '显示位置';
$lang->ai->prompts->prompt          = '提词';
$lang->ai->prompts->skill           = '挂载技能';
$lang->ai->prompts->knowledgeLib    = '挂载知识库';
...
$lang->ai->prompts->requiredField     = '必填';
$lang->ai->prompts->optionsLabel      = '选项: ';
...
$lang->ai->moduleList['doc']['title']            = '文档名称';
...
$lang->ai->moduleList['feedback']['common']      = '反馈';
$lang->ai->moduleList['ticket']['common']        = '工单';
$lang->ai->moduleList['issue']['common']         = '问题';
$lang->ai->moduleList['opportunity']['common']   = '机会';
$lang->ai->moduleList['risk']['common']          = '风险';
$lang->ai->moduleList['projectchange']['common'] = '变更';
$lang->ai->moduleList['cm']['common']            = '配置管理';
...
$lang->ai->targetForm['build']['common']          = '构建';
...
$lang->ai->targetForm['epic']['create']             = '提' . $lang->ERCommon;
$lang->ai->targetForm['epic']['batchcreate']        = '批量提' . $lang->ERCommon;
$lang->ai->targetForm['epic']['edit']               = '编辑' . $lang->ERCommon;
$lang->ai->targetForm['epic']['batchedit']          = '批量编辑' . $lang->ERCommon;
$lang->ai->targetForm['epic']['change']             = '变更' . $lang->ERCommon;
$lang->ai->targetForm['requirement']['create']      = '提' . $lang->URCommon;
$lang->ai->targetForm['requirement']['batchcreate'] = '批量提' . $lang->URCommon;
$lang->ai->targetForm['requirement']['edit']        = '编辑' . $lang->URCommon;
$lang->ai->targetForm['requirement']['batchedit']   = '批量编辑' . $lang->URCommon;
$lang->ai->targetForm['requirement']['change']      = '变更' . $lang->URCommon;
$lang->ai->targetForm['story']['create']            = '提' . $lang->SRCommon;
$lang->ai->targetForm['story']['batchcreate']       = '批量提' . $lang->SRCommon;
$lang->ai->targetForm['story']['totask']            = $lang->SRCommon . '建任务';
$lang->ai->targetForm['story']['testcasecreate']    = $lang->SRCommon . '建用例';
$lang->ai->targetForm['story']['edit']              = '编辑' . $lang->SRCommon;
$lang->ai->targetForm['story']['batchedit']         = '批量编辑' . $lang->SRCommon;
$lang->ai->targetForm['story']['change']            = '变更' . $lang->SRCommon;
$lang->ai->targetForm['story']['subdivide']         = $lang->SRCommon . '细分';
...
$lang->ai->targetForm['feedback']['batchcreate'] = '批量创建反馈';
$lang->ai->targetForm['feedback']['edit']        = '编辑反馈';
$lang->ai->targetForm['feedback']['batchedit']   = '批量编辑反馈';
...
$lang->ai->prompts->modules['build']         = '构建';
...
$lang->ai->formSchema['product']['create']->title = '产品';
...
$lang->ai->formSchema['product']['create']->properties->name->description      = '产品的名称';
$lang->ai->formSchema['product']['create']->properties->code->type             = 'string';
$lang->ai->formSchema['product']['create']->properties->code->description      = '产品的代号';
$lang->ai->formSchema['product']['create']->properties->type->type             = 'string';
$lang->ai->formSchema['product']['create']->properties->type->description      = '产品的类型';
...
$lang->ai->formSchema['product']['create']->properties->PO->description        = '产品的负责人';
$lang->ai->formSchema['product']['create']->properties->reviewer->type         = 'string';
$lang->ai->formSchema['product']['create']->properties->reviewer->description  = '产品的评审人，多个账号用逗号分隔';
$lang->ai->formSchema['product']['create']->properties->QD->type               = 'string';
$lang->ai->formSchema['product']['create']->properties->QD->description        = '产品的测试负责人';
$lang->ai->formSchema['product']['create']->properties->RD->type               = 'string';
$lang->ai->formSchema['product']['create']->properties->RD->description        = '产品的发布负责人';
...
$lang->ai->formSchema['product']['create']->properties->desc->description      = '产品的描述';
$lang->ai->formSchema['product']['create']->properties->acl->type              = 'string';
$lang->ai->formSchema['product']['create']->properties->acl->description       = '产品的访问控制';
...
$lang->ai->formSchema['product']['edit']->properties->status->description = '产品的状态';
...
$lang->ai->formSchema['feedback']['create']->title = '反馈';
...
$lang->ai->formSchema['feedback']['create']->properties->type->description        = '反馈的类型';
$lang->ai->formSchema['feedback']['create']->properties->title->type              = 'string';
$lang->ai->formSchema['feedback']['create']->properties->title->description       = '反馈的标题';
$lang->ai->formSchema['feedback']['create']->properties->pri->type                = 'string';
$lang->ai->formSchema['feedback']['create']->properties->pri->description         = '反馈的优先级';
...
$lang->ai->formSchema['feedback']['create']->properties->desc->description        = '反馈的描述';
$lang->ai->formSchema['feedback']['create']->properties->feedbackBy->type         = 'string';
$lang->ai->formSchema['feedback']['create']->properties->feedbackBy->description  = '反馈者';
$lang->ai->formSchema['feedback']['create']->properties->source->type             = 'string';
$lang->ai->formSchema['feedback']['create']->properties->source->description      = '反馈来源';
$lang->ai->formSchema['feedback']['create']->properties->notifyEmail->type        = 'string';
$lang->ai->formSchema['feedback']['create']->properties->notifyEmail->description = '通知邮箱';
$lang->ai->formSchema['feedback']['create']->properties->keywords->type           = 'string';
$lang->ai->formSchema['feedback']['create']->properties->keywords->description    = '关键词';
...
$lang->ai->formSchema['feedback']['batchcreate']->title = '批量创建反馈';
...
$lang->ai->formSchema['feedback']['batchcreate']->properties->feedbacks->description = '反馈列表';
...
$lang->ai->formSchema['feedback']['batchedit']->title = '批量编辑反馈';

$lang->ai->formSchema['ticket']['create'] = new stdclass();
$lang->ai->formSchema['ticket']['create']->title = '工单';
...
$lang->ai->formSchema['ticket']['create']->properties->title->description     = '工单的名称';
$lang->ai->formSchema['ticket']['create']->properties->type->type             = 'string';
$lang->ai->formSchema['ticket']['create']->properties->type->description      = '工单的类型';
...
$lang->ai->formSchema['ticket']['create']->properties->pri->description       = '工单的优先级';
...
$lang->ai->formSchema['ticket']['create']->properties->desc->description      = '工单的描述';
$lang->ai->formSchema['ticket']['create']->properties->estimate->type         = 'number';
$lang->ai->formSchema['ticket']['create']->properties->estimate->description  = '工单的预计工时';
...
$lang->ai->formSchema['ticket']['create']->properties->deadline->description  = '工单的截止日期';
$lang->ai->formSchema['ticket']['create']->properties->keywords->type         = 'string';
$lang->ai->formSchema['ticket']['create']->properties->keywords->description  = '关键字';
...
$lang->ai->formSchema['ticket']['batchcreate']->title = '批量创建工单';
...
$lang->ai->formSchema['ticket']['batchcreate']->properties->tickets->description = '工单列表';
...
$lang->ai->formSchema['ticket']['batchedit']->title = '批量编辑工单';

$lang->ai->formSchema['issue']['create'] = new stdclass();
$lang->ai->formSchema['issue']['create']->title = '问题';
...
$lang->ai->formSchema['issue']['create']->properties->title->description     = '问题的名称';
$lang->ai->formSchema['issue']['create']->properties->type->type             = 'string';
$lang->ai->formSchema['issue']['create']->properties->type->description      = '问题的类型';
...
$lang->ai->formSchema['issue']['create']->properties->severity->description  = '问题的严重程度';
...
$lang->ai->formSchema['issue']['create']->properties->pri->description       = '问题的优先级';
...
$lang->ai->formSchema['issue']['create']->properties->desc->description      = '问题的描述';
...
$lang->ai->formSchema['issue']['create']->properties->deadline->description  = '计划解决日期';
...
$lang->ai->formSchema['issue']['batchcreate']->title = '批量创建问题';
...
$lang->ai->formSchema['issue']['batchcreate']->properties->issues->description = '问题列表';
...
$lang->ai->formSchema['risk']['create']->title = '风险';
...
$lang->ai->formSchema['risk']['create']->properties->name->description        = '风险名称';
$lang->ai->formSchema['risk']['create']->properties->source->type             = 'string';
$lang->ai->formSchema['risk']['create']->properties->source->description      = '风险来源';
...
$lang->ai->formSchema['risk']['create']->properties->category->description    = '风险类型';
...
$lang->ai->formSchema['risk']['create']->properties->strategy->description    = '应对策略';
...
$lang->ai->formSchema['risk']['create']->properties->impact->description      = '影响程度';
...
$lang->ai->formSchema['risk']['create']->properties->probability->description = '发生概率';
...
$lang->ai->formSchema['risk']['create']->properties->pri->description         = '优先级';
...
$lang->ai->formSchema['risk']['create']->properties->prevention->description  = '应对措施';
$lang->ai->formSchema['risk']['create']->properties->remedy->type             = 'string';
$lang->ai->formSchema['risk']['create']->properties->remedy->format           = 'html';
$lang->ai->formSchema['risk']['create']->properties->remedy->description      = '响应措施';
...
$lang->ai->formSchema['risk']['batchcreate']->title = '批量创建风险';
...
$lang->ai->formSchema['risk']['batchcreate']->properties->risks->description = '风险列表';

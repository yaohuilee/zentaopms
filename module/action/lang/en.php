...
$lang->action->changedStoryStage = new stdclass();
$lang->action->changedStoryStage->common         = '%s, updated stage to %s';
$lang->action->changedStoryStage->commonWithLink = '%s %s, updated stage to %s';
$lang->action->changedStoryStage->editStory      = 'edited the story';
$lang->action->changedStoryStage->closeStory     = 'closed the story';
$lang->action->changedStoryStage->activateStory  = 'activated the story';
$lang->action->changedStoryStage->linkPlan       = 'linked to plan';
$lang->action->changedStoryStage->unlinkPlan     = 'removed from plan';
$lang->action->changedStoryStage->linkProject    = 'linked to project';
$lang->action->changedStoryStage->unlinkProject  = 'removed from project';
$lang->action->changedStoryStage->linkRelease    = 'linked to release';
$lang->action->changedStoryStage->unlinkRelease  = 'removed from release';
$lang->action->changedStoryStage->editRelease    = 'edited release';
$lang->action->changedStoryStage->publishRelease = 'published release';
$lang->action->changedStoryStage->startTask      = 'started task';
$lang->action->changedStoryStage->activateTask   = 'activated task';
$lang->action->changedStoryStage->finishTask     = 'finished task';
$lang->action->changedStoryStage->cancelTask     = 'canceled task';
$lang->action->changedStoryStage->closeTask      = 'closed task';
$lang->action->changedStoryStage->editTask       = 'edited task';
$lang->action->changedStoryStage->recordEffort   = 'recorded work hours of task %s';
$lang->action->changedStoryStage->editEffort     = 'edited work hours of task %s';
$lang->action->changedStoryStage->deleteEffort   = 'deleted work hours of task %s';
$lang->action->changedStoryStage->deleteTask     = 'deleted task';
$lang->action->changedStoryStage->createTask     = 'created task';
$lang->action->changedStoryStage->undeleteTask   = 'restored task';

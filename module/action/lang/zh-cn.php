...
$lang->action->changedStoryStage->common         = '%s，阶段更新为 %s';
$lang->action->changedStoryStage->commonWithLink = '%s %s，阶段更新为 %s';
$lang->action->changedStoryStage->editStory      = '编辑需求后';
$lang->action->changedStoryStage->closeStory     = '关闭需求后';
$lang->action->changedStoryStage->activateStory  = '激活需求后';
$lang->action->changedStoryStage->linkPlan       = '关联到计划';
$lang->action->changedStoryStage->unlinkPlan     = '移除了计划';
$lang->action->changedStoryStage->linkProject    = '关联到项目';
$lang->action->changedStoryStage->unlinkProject  = '移除了项目';
$lang->action->changedStoryStage->linkRelease    = '关联到发布';
$lang->action->changedStoryStage->unlinkRelease  = '移除了发布';
$lang->action->changedStoryStage->editRelease    = '编辑了发布';
$lang->action->changedStoryStage->publishRelease = '发布了发布';
$lang->action->changedStoryStage->startTask      = '开始了任务';
$lang->action->changedStoryStage->activateTask   = '激活了任务';
$lang->action->changedStoryStage->finishTask     = '完成了任务';
$lang->action->changedStoryStage->cancelTask     = '取消了任务';
$lang->action->changedStoryStage->closeTask      = '关闭了任务';
$lang->action->changedStoryStage->editTask       = '编辑了任务';
$lang->action->changedStoryStage->recordEffort   = '记录了任务 %s 工时后';
$lang->action->changedStoryStage->editEffort     = '编辑了任务 %s 工时后';
$lang->action->changedStoryStage->deleteEffort   = '删除了任务 %s 工时后';
$lang->action->changedStoryStage->deleteTask     = '删除了任务';
$lang->action->changedStoryStage->createTask     = '创建了任务';
$lang->action->changedStoryStage->undeleteTask   = '还原了任务';

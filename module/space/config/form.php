...
$config->space->form->create['createdDate'] = array('type' => 'datetime', 'required' => false, 'default' => $now);

$config->space->form->edit = $config->space->form->create;
$config->space->form->edit['editedDate'] = array('type' => 'datetime', 'required' => false, 'default' => $now);

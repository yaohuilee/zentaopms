...
class zaiModelTest extends baseTest
{
    protected $moduleName = 'zai';
    protected $className  = 'model';

    public function getSettingTest($includeAdmin = false): ?object
    {
        $result = $this->instance->getSetting($includeAdmin);
        return $result;
    }
    ...
    {
        $result = $this->instance->getToken($zaiConfig, $admin);
    ...
    {
        $result = $this->instance->formatOldSetting($setting);
        if(dao::isError()) return dao::getError();
    ...
    {
        $this->instance->setSetting($setting);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getVectorizedInfo();
        if(dao::isError()) return dao::getError();
    ...
    {
        $this->instance->setVectorizedInfo($info);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->syncNextTarget($memoryID, $type, $id);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->callAPI($path, $method, $params, $postData, $admin);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->callAdminAPI($path, $method, $params, $postData);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->canViewObject($objectType, $objectID, $attrs);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->searchKnowledges($query, $collection, $filter, $limit, $minSimilarity);
        return $result;
    }
    ...
    {
        $result = $this->instance->searchKnowledgeChunks($query, $collection, $filter, $limit, $minSimilarity);
        return $result;
    }
    ...
    {
        $result = $this->instance->getCollectionKey($collection);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->searchKnowledgesInCollections($query, $filters, $type, $limit, $minSimilarity);
        return $result;
    }
    ...
    {
        $result = $this->instance->filterKnowledgesByPriv($knowledges, $type, $limit);
        return $result;
    }
    ...
    {
        $result = $this->instance->createKnowledgeLib($name, $description, $options);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->deleteKnowledgeLib($memoryID);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->updateKnowledgeItem($memoryID, $key, $content, $contentType, $attrs);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->deleteKnowledgeItem($memoryID, $key);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getKnowledgeChunks($memoryID, $contentID);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->extractFileContent($fileID);
        if(dao::isError()) return dao::getError();

...
title=测试 zaiModel::syncVectorization()
timeout=0
cid=0

- 步骤1：正常输入 @array:skip,0,0,obj
- 步骤2：边界值输入 @array:skip,0,0,obj
- 步骤3：无效输入 @array:skip,0,0,obj
- 步骤4：大值输入 @array:skip,0,0,obj
- 步骤5：业务规则验证 @array:skip,0,0,obj

*/

r(ztfVal(ztfCall(function() use ($tester) { return $tester->zai->syncVectorization(); }))) && p() && e('array:skip,0,0,obj'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->zai->syncVectorization(); }))) && p() && e('array:skip,0,0,obj'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->zai->syncVectorization(); }))) && p() && e('array:skip,0,0,obj'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->zai->syncVectorization(); }))) && p() && e('array:skip,0,0,obj'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->zai->syncVectorization(); }))) && p() && e('array:skip,0,0,obj'); // 步骤5：业务规则验证

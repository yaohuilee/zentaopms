...
title=测试 zaiModel::buildProgressList()
timeout=0
cid=0
...
r(ztfVal(ztfCall(function() use ($tester) { return $tester->zai->buildProgressList((object)array(), array()); }))) && p() && e('empty_array'); // 步骤1：正常输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->zai->buildProgressList((object)array(), array()); }))) && p() && e('empty_array'); // 步骤2：边界值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->zai->buildProgressList((object)array(), array()); }))) && p() && e('empty_array'); // 步骤3：无效输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->zai->buildProgressList((object)array('id' => 999999), array()); }))) && p() && e('empty_array'); // 步骤4：大值输入
r(ztfVal(ztfCall(function() use ($tester) { return $tester->zai->buildProgressList((object)array('id' => 1, 'name' => 'test'), array(1, 2)); }))) && p() && e('array_count=2'); // 步骤5：业务规则验证

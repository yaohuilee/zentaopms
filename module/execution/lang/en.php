...
$lang->execution->closedBy            = 'Closed by';
$lang->execution->closedDate          = 'Closed Date';
$lang->execution->canceledBy          = 'Canceled by';
$lang->execution->canceledDate        = 'Canceled Date';
$lang->execution->begin               = 'Planned Start';
$lang->execution->end                 = 'Planned End';
$lang->execution->dateRange           = 'Plan Duration';
$lang->execution->realBeganAB         = 'Actual Start';
...
$lang->execution->consumedHours = 'Cost';
...
$lang->execution->testcase                  = 'Test Case List';
$lang->execution->dynamic                   = 'Recents';
$lang->execution->latestDynamic             = 'Recents';
...
$lang->execution->lblStats             = 'Effort';
$lang->execution->DurationStats        = 'Duration Information';
$lang->execution->stats                = 'Available: <strong>%s</strong>h. Estimate: <strong>%s</strong>h. Cost: <strong>%s</strong>h. Left: <strong>%s</strong>h.';
$lang->execution->taskSummary          = "Total: <strong>%s</strong> task(s). Waiting: <strong>%s</strong>. Doing: <strong>%s</strong>. Estimate: <strong>%s</strong>h. Cost: <strong>%s</strong>h. Left: <strong>%s</strong>h.";
$lang->execution->pageSummary          = "Total tasks: <strong>%total%</strong>. Waiting: <strong>%wait%</strong>. Doing: <strong>%doing%</strong>.    Estimate: <strong>%estimate%</strong>h. Cost: <strong>%consumed%</strong>h. Left: <strong>%left%</strong>h.";
$lang->execution->checkedSummary       = "Selected: <strong>%total%</strong>. Waiting: <strong>%wait%</strong>. Doing: <strong>%doing%</strong>. Estimate: <strong>%estimate%</strong>h. Cost: <strong>%consumed%</strong>h. Left: <strong>%left%</strong>h.";
...
$lang->execution->timeSummary          = '<div class="table-col"><div class="clearfix segments"><div class="segment"><div class="segment-title">Estimate</div><div class="segment-value">%s</div></div><div class="segment"><div class="segment-title">Cost</div><div class="segment-value text-red">%s</div></div><div class="segment"><div class="segment-title">Left</div><div class="segment-value">%s</div></div></div></div>';
$lang->execution->groupSummaryAB       = "<div>Tasks <strong>%s ：</strong><span class='text-muted'>Waiting</span> %s &nbsp; <span class='text-muted'>Doing</span> %s</div><div>Estimate <strong>%s ：</strong><span class='text-muted'>Cost</span> %s &nbsp; <span class='text-muted'>Left</span> %s</div>";

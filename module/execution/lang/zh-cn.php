...
$lang->execution->agileplusMethodTip = "融合{$lang->projectCommon}创建执行时，支持{$lang->executionCommon}和看板两种管理方法。";
...
$lang->execution->errorFloat                   = '『%s』应当是不小于0的数字，可以是小数。';
...
$lang->execution->gobackExecution              = "返回{$lang->execution->common}列表";

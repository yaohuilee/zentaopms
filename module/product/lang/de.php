...
$lang->product->confirmDeleteWithProjects = "Die verknüpften Projekte %s sind noch nicht geschlossen. Nach dem Löschen dieses {$lang->productCommon} werden die Story-Daten in diesen Projekten geleert. Möchten Sie dieses {$lang->productCommon} wirklich löschen?";

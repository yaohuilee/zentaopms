...
$lang->product->confirmDeleteWithProjects = "该{$lang->productCommon}关联的{$lang->projectCommon}中 %s {$lang->projectCommon}还未关闭，删除{$lang->productCommon}后，{$lang->projectCommon}中的需求数据将被清空，您确认要删除该{$lang->productCommon}吗？";

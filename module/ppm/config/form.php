...
$config->ppm->form->create['createdDate']    = array('type' => 'string', 'required' => false, 'default' => $now);
...
$config->ppm->form->edit['editedDate'] = array('type' => 'string', 'required' => false, 'default' => $now);

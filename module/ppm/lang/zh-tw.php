...
$lang->ppm->diffHub->labels['files']                   = '檔案';
$lang->ppm->diffHub->labels['close']                   = '關閉';
$lang->ppm->diffHub->labels['product']                 = '產品';
$lang->ppm->diffHub->labels['module']                  = '模組';
$lang->ppm->diffHub->labels['save']                    = '保存';
$lang->ppm->diffHub->labels['unified-view']            = '切換為統一檢視';
$lang->ppm->diffHub->labels['split-view']              = '切換為分欄檢視';
$lang->ppm->diffHub->labels['collapse-all']            = '摺疊全部檔案';
$lang->ppm->diffHub->labels['expand-all']              = '展開全部檔案';
$lang->ppm->diffHub->labels['collapse-diff']           = '摺疊 Diff';
$lang->ppm->diffHub->labels['expand-diff']             = '展開 Diff';
$lang->ppm->diffHub->labels['content-placeholder']     = '請輸入評審建議，可使用 Markdown 語法';
$lang->ppm->diffHub->labels['edit-range']              = '點擊修改範圍';
$lang->ppm->diffHub->labels['range-start']             = '起始行';
$lang->ppm->diffHub->labels['range-end']               = '終止行';
$lang->ppm->diffHub->labels['range-not-visible']       = '%s 行不在可見範圍內';
$lang->ppm->diffHub->labels['status-active']           = '激活';
$lang->ppm->diffHub->labels['status-resolved']         = '已解決';
$lang->ppm->diffHub->labels['status-closed']           = '已關閉';
$lang->ppm->diffHub->labels['status-active-confirmed'] = '激活';
$lang->ppm->diffHub->labels['operate-confirm']         = '確認';
$lang->ppm->diffHub->labels['operate-assign']          = '指派';
$lang->ppm->diffHub->labels['operate-resolve']         = '解決';

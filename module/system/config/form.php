...
$config->system->form->create['createdDate'] = array('type' => 'datetime', 'required' => false, 'default' => $now);
...
$config->system->form->edit['editedDate'] = array('type' => 'datetime', 'required' => false, 'default' => $now);
